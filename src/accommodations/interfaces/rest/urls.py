...
from src.reviews.interfaces.rest.views import AccommodationReviewsView
from .views import (
...
urlpatterns = [
    ...
    path("<int:accommodation_id>/reviews/", AccommodationReviewsView.as_view(), name="accommodations-reviews"), # GET/POST
